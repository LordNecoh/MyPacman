...
void ghostsCollisions(State& state) {
    if (doesGhostCollide(state.ghosts.Pink, state.pacman) ||
        doesGhostCollide(state.ghosts.Red, state.pacman) ||
        doesGhostCollide(state.ghosts.Orange, state.pacman) ||
        doesGhostCollide(state.ghosts.Green, state.pacman)) {
