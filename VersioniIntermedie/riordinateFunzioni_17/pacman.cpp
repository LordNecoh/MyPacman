...
const float LIFE_OFFSET = 22.f; //Offset between lives

//Constants for scaling
const float SPRITES_SCALE = 1.5f; 
const float LIFE_SCALE = 1.0f;
...
const sf::Vector2f LIFETEXT_POSITION(160, SCOREBOARD_Y);
const sf::Vector2f LIFE_POSITION(235, SCOREBOARD_Y);
const sf::Vector2f HIGHSCORE_POSITION(300, SCOREBOARD_Y); 
const sf::Vector2f HIGHSCORE_TEXT_MENUPOSITION(WINDOW_WIDTH / 2.f, WINDOW_HEIGHT / 2.f + 50.f);
const sf::Vector2f HIGHSCORE_MENUPOSITION(WINDOW_WIDTH / 2.f, WINDOW_HEIGHT / 2.f + 75.f);

const sf::Vector2i CHARACTER_VECTOR(CHARACTER_SIZE, CHARACTER_SIZE); //Used for the texture rects
...
/*
    Problemi attuali:
    -Provare a mettere a 18 la CHARACTER_SIZE
